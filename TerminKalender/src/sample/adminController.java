...
public class adminController implements Initializable {
    ...
    //Hier wird repräsentiert das Mittel mit dem ,ein Benutzer mittels sein ID aus der DATABASE gelöscht werden könnte
    ...
    //SQL-Befehle werden somit ausgeführt/durchgeführt
    ...
    //Die Database-Verbindung oder Verbindung zur Database wird ermoeglicht
    ...
    /*Table View from DB----> Hier implementieren wir die Methoden die uns die Möglichkeit gibt, als Admin die Komplette DATABASE
    mit den beinhaltenden Informationen aufzurufen*/
    ...
    /*"ShowUsers----> Mit diesem Code Abschnitt, kann der Admin die Liste von allen registrierten User in dem Kalender System sich anzeigen lassen*/
